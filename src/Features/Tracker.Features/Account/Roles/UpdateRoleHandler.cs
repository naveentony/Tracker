...
{
    public class UpdateRoleHandler : IRequestHandler<Role, OperationResult<Unit>>
    {
        ...
        public UpdateRoleHandler(ICollectionProvider provider, RoleManager<MongoRoleDto> roleManager, UserManager<UsersDto> userManager)
        {
